...
A relentless thirst for learning and an ardent commitment to driving significant innovation underscore my motivation. I am poised to leverage my hands–on experience and academic endeavors to delve deeper into the realms of machine construction and programming, surmounting complex challenges in pursuit of progress.
The convergence of my educational foundations, diverse professional experiences, and an unwavering commitment to innovation forms the bedrock of my journey. As a seasoned 'jack of all trades' engineer, I am determined to further elevate my expertise in engineering and technology.
...
## Academic Projects
### Control of an Advanced Driver Assistance System (ADAS) over the 5G–Network


***Project Overview:*** This project aimed to create an advanced driver assistance system (ADAS) controlled over a 5G network, focusing on innovation, integration, technical expertise, safety, efficiency, real–world application, and collaboration. The objective was to develop a secure, efficient, and cutting–edge control system for autonomous vehicles, emphasizing the use of 5G technology and external sensor data integration.

***Innovation and Integration:*** The core of the project involved crafting a sophisticated 5G–enabled ADAS control system, designed to seamlessly manage real–time data transmission, remote control capabilities, and monitoring functions for autonomous vehicles. The innovative approach centered on providing a solution that integrates different aspects crucial for autonomous vehicle management.

***Technical Expertise:*** The project utilized MATLAB/Simulink to engineer a robust control solution for the Drive by Wire System in a Jeep Grand Cherokee. The implementation integrated high–end hardware components like the New Eagle hardware, a MicroAutoBox 2 Controller from dSPACE, and the Global Navigation Satellite System (GNSS). This integration aimed to bolster safety and efficiency through the application of 5G technology and the incorporation of external sensor data.

***Safety and Efficiency Focus:*** The primary focus was to enhance safety and efficiency in the autonomous vehicle domain. The 5G–enabled ADAS control system not only facilitated remote control and monitoring but also prioritized secure and reliable real–time data transmission. These features significantly contributed to the overall safety of vehicle management.

***Real–World Application:*** Implementing this project on the Jeep Grand Cherokee provided a practical application, demonstrating how the solution adapts and aligns with real–world automotive scenarios. This exemplified the adaptability and relevance of the developed solution in the automotive industry.

***Collaboration and System Integration:*** The successful amalgamation of diverse hardware components and software solutions from different providers highlighted strong collaboration skills, system integration capabilities, and a deep understanding of varied technological systems. This showcased an ability to effectively bring together multiple technologies for a cohesive solution.
...
A significant achievement of the project was the successful implementation of the trained CNN model on real–time video streams. This deployment facilitated the identification and classification of distracted drivers across diverse driving conditions, directly contributing to real–world applications that are crucial for enhancing road safety. Through assessing the software's performance and accuracy, the project made substantial strides in effectively identifying and flagging instances of distracted driving, which significantly impacts driver safety.

The success of this project goes beyond technological advancements; it directly influences and improves road safety and driver monitoring. Leveraging a CNN model for real–time detection represents a fusion of theoretical expertise and practical application, showcasing the capacity to solve complex real–world problems using advanced technology.

Moreover, the project outcomes highlight the significance of accurate, real–time monitoring in situations that can potentially save lives. This holds paramount importance in industries such as automotive technology, transportation, and safety. The project's success is a result of combining innovative deep learning techniques, the real–time implementation of the model, and a critical evaluation of its accuracy, exemplifying a holistic approach to addressing critical issues in driver safety.
...
### Robotics Nano Projects (Self–Balancing Robot, Webcam Controlled Rover Bot, Vertical Drawing Robot)


[Vertical Drawing Bot](https://www.youtube.com/watch?v=6fa-gCx74Fg)


[Webcam Controlled Rover Bot](https://www.youtube.com/watch?v=cCVUTY2_NfM)


[Self–Balancing Bike Robot](https://www.youtube.com/watch?v=PT3bBPZd–Gk)
...
- Hardware Development and Integration: I applied my expertise in Arduino IDE and MATLAB to intricately program and configure the ultrasonic sensor. This meticulous process ensured precise object detection and accurate determination of their positions within the radar's field of view
- Simulation and Verification: To guarantee optimal functionality before physical assembly, I utilized Tinkercad for detailed simulations. This rigorous approach enabled us to fine–tune the system for high accuracy in object detection and effective parameter display.
- Multi–Attribute Measurement: The system was engineered to excel in measuring various physical attributes, such as distance, speed, and object positions. This was achieved through the strategic utilization of electromagnetic waves and sensor technology, showcasing the versatility of our radar.
- Components Integration: I seamlessly integrated multiple components, including the Arduino Uno, servo motors, ultrasonic sensors, resistors, and LEDs, demonstrating a deep understanding of hardware integration. This comprehensive integration was pivotal to the radar's efficiency.


***Innovative Tools and Design Proficiency***
- MATLAB Visualization and Integration: Through effective collaboration, we integrated MATLAB to provide intuitive and comprehensive visualizations of detected objects and their proximity. Additionally, this integration enhanced the radar's functionalities through LED responses, making it user–friendly and informative
- Enclosure Design: I meticulously designed enclosures for the hardware components using Autodesk Inventor Professional, emphasizing a high level of proficiency in hardware design and seamless integration. This not only enhanced the system's aesthetic appeal but also ensured its practicality in real–world applications
